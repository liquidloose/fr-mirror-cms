 ...
 * Slug: fr-mirror/content-article
 * Inserter: no
 */
?>
...
<!-- wp:post-date {"style":{"spacing":{"margin":{"bottom":"33px"}}}} /-->

<!-- wp:post-content /--></div>
<!-- /wp:column -->

<!-- wp:column {"width":"33.33%","style":{"spacing":{"blockGap":"var:preset|spacing|40"},"border":{"radius":"0px","width":"0px","style":"none"}},"layout":{"type":"default"}} -->
<div class="wp-block-column" style="border-style:none;border-width:0px;border-radius:0px;flex-basis:33.33%"><!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e('Quote of the day:', 'fr-mirror');?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php esc_html_e('Stop allowing your mind to be a slave, to be jerked about by selfish impulses, to kick against fate and the present, and to mistrust the future.', 'fr-mirror');?></p>
<!-- /wp:paragraph -->
